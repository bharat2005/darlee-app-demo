    ...
    if(currentIndex === 0) {
        return (
            <View style={{height:'100%', width:'100%'}}>
                <Image source={{uri:fuckData?.stepsData[currentIndex]?.boxImage}} style={{height:'50%', width:'100%'}} />
...
<Flowers width={28} height={28} />
  ...
  return (
    <View style={{height:'100%', width:'100%', flexDirection:'column-reverse', gap:38, paddingBottom:34}}>
          <Image source={{uri:fuckData?.stepsData[currentIndex]?.boxImage}} style={{height:'60%', width:'100%'}} />
